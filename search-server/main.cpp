...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status = DocumentStatus::ACTUAL) const {
        auto finder_predicate = [status](int document_id, DocumentStatus status_l, int rating) {
            return status_l == status; };
        return FindTopDocuments(raw_query, finder_predicate);
    }
